    ...
    <div className="page-title-home4">
      <div className="image-bg">
        <div className="image1">
          <img alt="" src="/images/item/item-5.png" width={30} height={102} />
        </div>
        <div className="image2">
          <img alt="" src="/images/item/item-6.png" width={178} height={74} />
        </div>
        <div className="image3">
          <img alt="" src="/images/item/item-7.png" width={134} height={182} />
        </div>
        ...
        <div className="image4">
          <img alt="" src="/images/item/item-8.png" width={256} height={253} />
        </div>
        <div className="image6">
          <img alt="" src="/images/item/item-10.png" width={274} height={280} />
        </div>
        <div className="image7">
          <img alt="" src="/images/item/item-11.png" width={136} height={217} />
        </div>
      </div>
