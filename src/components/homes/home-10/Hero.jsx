    ...
    <div className="page-title-home10">
      <div className="image-bg">
        <div className="image1">
          <img alt="" src="/images/item/item-12.png" width={358} height={736} />
        </div>
        <div className="image2">
          <img alt="" src="/images/item/item-13.png" width={520} height={590} />
        </div>
        <div className="image3">
          <img alt="" src="/images/item/item-14.png" width={422} height={320} />
        </div>
      </div>
